...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('lbforum_topic', 'forum_id')

        # Deleting field 'Topic.topic_type'
        db.delete_column('lbforum_topic', 'topic_type_id')

        # Adding field 'Topic.category'
        db.add_column('lbforum_topic', 'category', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['lbforum.Category']), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Topic.forum'
        raise RuntimeError("Cannot reverse this migration. 'Topic.forum' and its values cannot be restored.")
        ...
        db.delete_column('lbforum_topic', 'category_id')
